...
export default function LoginModal() {
  ...
  return (
    <dialog
      ...
      className="w-full max-w-96 flex flex-col gap-3 p-4 absolute top-1/4 -translate-y-1/4 left-1/2 -translate-x-1/2 rounded border border-base-border dark:border-[#494949]  bg-base-100 dark:bg-dark-base-100 backdrop:bg-black/45"
    >

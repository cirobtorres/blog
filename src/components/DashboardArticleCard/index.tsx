...
const DashboardArticleCard = ({
  ...
  blocked_for_replies: blockedForReplies,
}: {
  id: string;
  title: string;
  sub_title: string;
  ...
  return (
    <li
      onClick={(event) => {
        ...
        setSlug(slug);
        setPrivateArticle(privateArticle);
        setBlockedForReplies(blockedForReplies);

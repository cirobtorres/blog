...
const NavBar = () => {
  ...
  return (
    <nav
      id="dashboard-navbar"
      className="z-[5] absolute top-0 left-0 bottom-0 w-14 h-full hover:w-52 overflow-hidden p-2 transition-all duration-300 border-r border-base-200 dark:border-dark-base-border bg-base-200 dark:bg-dark-base-300"
    >

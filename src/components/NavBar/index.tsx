...
const NavBar = () => {
  ...
  return (
    <nav
      id="dashboard-navbar"
      className="flex-shrink-0 z-[5] absolute tablet:static top-0 left-0 bottom-0 flex flex-col w-14 tablet:w-64 h-full hover:w-64 overflow-hidden transition-all duration-300 border-r border-base-200 dark:border-dark-base-border bg-base-100 dark:bg-dark-base-100"
    >
      ...
      <div className="border-b borde-base-200 dark:border-dark-base-border tablet:pt-7 tablet:pb-4 max-[900px]:p-2">
        ...
        <div className="border-t borde-base-200 dark:border-dark-base-border mt-2 tablet:mt-8 pt-2 tablet:pt-4 tablet:pl-4">
          <button
            onClick={(event) => {

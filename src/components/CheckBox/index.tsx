...
export default function CheckBox<T extends string>({
  ...
  return (
    <label
      htmlFor={id}
      className={`checkbox-wrapper-30 text-sm flex items-center gap-1 cursor-pointer w-fit text-base-neutral hover:text-base-neutral-hover dark:text-dark-base-neutral dark:hover:text-dark-base-neutral-hover`}
    >
      <span

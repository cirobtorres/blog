...
//   // Add <br/> when breaking lines inside EditorContent
  ...
  const editor = useEditor({
    ...
    extensions: [
      StarterKit.configure({
        paragraph: {
          HTMLAttributes: {
            class: "w-full text-base-neutral mb-4 dark:text-dark-base-neutral",
          },
        },
        heading: {
          HTMLAttributes: {
            class:
              "w-full font-extrabold uppercase mb-8 text-base-neutral dark:text-dark-base-neutral",
          },
          levels: [3],
        },
        bold: {
        ...
        bulletList: {
          HTMLAttributes: {
            class:
              "w-full pl-6 mb-4 [&_li]:pl-4 list-disc [&_li]:marker:text-base-green dark:[&_li]:marker:text-dark-base-green text-base-neutral dark:text-dark-base-neutral mb-4",
          },
        },
        orderedList: {
          HTMLAttributes: {
            class:
              "w-full pl-6 mb-4 [&_li]:pl-4 list-decimal [&_li]:marker:text-base-green dark:[&_li]:marker:text-dark-base-green text-base-neutral dark:text-dark-base-neutral mb-4",
          },
        },
        codeBlock: {
        ...
        blockquote: {
          HTMLAttributes: {
            class: `relative italic font-semibold mb-4 pl-10 [&_p]:indent-10
              ...
              [&_p]:after:absolute [&_p]:after:-bottom-2 [&_p]:after:indent-2 [&_p]:after:font-serif [&_p]:after:content-['”'] [&_p]:after:text-5xl [&_p]:after:text-base-green dark:[&_p]:after:text-dark-base-green`,
          },
        },
      }),
      // HardBreak.configure({
    ...
    editor && (
      <div className="relative w-full flex flex-col border border-base-200 dark:border-dark-base-border bg-base-100 dark:bg-dark-base-200">
        ...
        <ArticleEditorContent
          editor={editor}
          className="m-1" // border border-base-200 dark:border-dark-base-border
        />
      </div>
    )
  );

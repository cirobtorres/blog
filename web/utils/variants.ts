...
const buttonVariants = cva(
  "cursor-pointer border disabled:cursor-auto rounded text-sm font-medium inline-flex items-center justify-center whitespace-nowrap transition-all duration-300 shrink-0 outline-none group/button select-none h-10.5 gap-1.5 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 not-dark:shadow focus-visible:border-primary dark:focus-visible:border-primary [&_svg]:shrink-0 [&_svg]:pointer-events-none [&_svg]:size-4 " +
    focusRing,
  {
    variants: {
      variant: {

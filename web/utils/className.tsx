...
const buttonVariants = cva(
  "cursor-pointer rounded border border-transparent bg-clip-padding text-sm font-medium [&_svg:not([class*='size-'])]:size-4 inline-flex items-center justify-center whitespace-nowrap transition-all duration-300 disabled:pointer-events-none disabled:transition-none [&_svg]:pointer-events-none shrink-0 [&_svg]:shrink-0 outline-none group/button select-none h-8 gap-1.5 px-2.5 has-data-[icon=inline-end]:pr-2 has-data-[icon=inline-start]:pl-2 " +
    focusRing,
  {
    variants: {
      variant: {
        ...
        outline:
          "text-muted-foreground hover:text-foreground bg-background dark:bg-input/30 dark:border-input aria-expanded:bg-muted aria-expanded:text-foreground",
        secondary:
...
const linkVariants = cva(
  cn(
    "w-fit text-sm font-sans rounded-md transition-[border,color,box-shadow,background] duration-300",
    focusRing,
  ),
  {
    variants: {
      variant: {
        ...
        button:
          "w-full flex items-center justify-center h-10 no-underline text-muted-foreground bg-muted hover:text-foreground dark:bg-card dark:hover:text-foreground border dark:hover:border-border-accent",
      },
    },
    defaultVariants: {
      variant: "external",

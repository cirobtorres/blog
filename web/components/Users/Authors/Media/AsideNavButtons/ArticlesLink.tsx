...
export interface ArticlesLinkHandle {
  startAnimation: () => void;
  stopAnimation: () => void;
}

interface ArticlesLinkProps extends React.HTMLAttributes<HTMLAnchorElement> {
  size?: number;
}
...
export const ArticlesLink = React.forwardRef<
  ArticlesLinkHandle,
  ArticlesLinkProps
...
ArticlesLink.displayName = "ArticlesLink";

...
import { useCreateTag } from "../../../../services/hooks/tags/hook-tags";
...
export default function TagCreate({ tags }: { tags: Tag[] }) {
  ...
  const [localErrors, setLocalErrors] = React.useState<TagErrors | null>(null);
  ...
  const displayErrors = state.error ? { name: state.error } : localErrors;

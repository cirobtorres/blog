...
export function Header() {
  return (
    <header className="z-10 w-full fixed top-0 h-header flex items-center px-6 backdrop-blur-sm border-neutral-200 bg-neutral-100/50 dark:border-neutral-800 dark:bg-neutral-900/50">

...
function AccordionContent({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "pt-0 pb-2.5 [&_a]:hover:text-neutral-100 h-(--radix-accordion-content-height) [&_a]:underline [&_a]:underline-offset-3 [&_p:not(:last-child)]:mb-4",
          className,
        )}
      >
        {children}

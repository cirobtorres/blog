...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        "text-neutral-400 dark:text-neutral-500 px-1.5 py-1 text-xs font-medium data-inset:pl-7",
        className,
      )}
      {...props}
    />
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-neutral-400 dark:text-neutral-500 ml-auto text-xs tracking-widest",
        className,
      )}
      {...props}
    />

...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "text-neutral-900 dark:text-neutral-100 **:[[cmdk-group-heading]]:text-muted-foreground overflow-hidden p-1 **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:text-xs **:[[cmdk-group-heading]]:font-medium",
        className,
      )}
      {...props}
    />
...
function CommandShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "text-xs tracking-widest ml-auto text-neutral-400 dark:text-neutral-500 group-data-selected/command-item:text-neutral-900 dark:group-data-selected/command-item:text-neutral-100",
        className,
      )}
      {...props}
    />

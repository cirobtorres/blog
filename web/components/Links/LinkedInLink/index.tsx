...
const LinkedInLink = ({
  ...
  return (
    <a
      ...
      target="_self"
      className={cn(
        "w-full h-10.5 flex justify-center items-center gap-2 rounded cursor-pointer transition-shadow duration-300 text-base shadow font-medium bg-popover",
        focusRing,
        className,
      )}
    >
